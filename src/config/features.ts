...
export const POLAR_CONFIG = {
    ...
    IDENTITY_SOLO_PRODUCT_ID: process.env.NEXT_PUBLIC_POLAR_IDENTITY_SOLO_PRODUCT_ID || '',
    IDENTITY_DUO_PRODUCT_ID: process.env.NEXT_PUBLIC_POLAR_IDENTITY_DUO_PRODUCT_ID || '',
    ...
    COUPLE_PRICE: 15.00,
    SPY_PRICE: 10.00,
    IDENTITY_SOLO_PRICE: 3.00,
    IDENTITY_DUO_PRICE: 5.00,
};
